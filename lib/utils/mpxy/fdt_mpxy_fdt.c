...
static int init_fdt_from_table(void *new_fdt, void *base_fdt, int nentries,
...
static int copy_all_properties_(void *new_fdt, void *base_fdt,
...
static int copy_fdt_cpus(void *new_fdt, void *base_fdt, struct sbi_domain *dom)
{
	int i, rc;
...
static int copy_fdt_devices(void *new_fdt, void *base_fdt, struct sbi_domain *dom)
{
	int i, j, rc;
...
static int mpxy_fdt_setup_fdt(void *base_fdt, struct sbi_mpxy_channel *channel)
{
	int rc;
	struct mpxy_fdt_info *info = channel->opaque;
...
static int mpxy_fdt_parse(void *fdt, int nodeoff,
...
static int mpxy_fdt_init(void *fdt, int nodeoff,
